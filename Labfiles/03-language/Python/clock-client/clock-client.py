    ...
    try:
        ...
        while userText.lower() != 'quit':
            ...
            if userText.lower() != 'quit':
                ...
                # Create a client for the Language service model# Create a client for the Language service model
                client = ConversationAnalysisClient(
                    ls_prediction_endpoint, AzureKeyCredential(ls_prediction_key))

                # Call the Language service model to get intent and entities# Call the Language service model to get intent and entities
                cls_project = 'Clock'
                ...
                # Apply the appropriate action# Apply the appropriate action
